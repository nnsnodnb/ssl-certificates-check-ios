...
let package = Package(
  ...
  dependencies: [
    ...
    .package(url: "https://github.com/RevenueCat/purchases-ios-spm.git", .upToNextMajor(from: "5.88.0")),
    ...
    .package(url: "https://github.com/apple/swift-certificates.git", .upToNextMajor(from: "1.20.0")),
    .package(
